...
router.patch("/admin/clients/:clientId/unban", clientsController.unbanClient); //Разблокировать клиента
router.get("/clients/:clientId/rent", clientsController.rentBook); //Арендовать книгу
